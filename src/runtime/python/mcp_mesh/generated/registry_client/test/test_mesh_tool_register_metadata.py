...
class TestMeshToolRegisterMetadata(unittest.TestCase):
    """MeshToolRegisterMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeshToolRegisterMetadata:
        """Test MeshToolRegisterMetadata
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MeshToolRegisterMetadata`
        """
        model = MeshToolRegisterMetadata()
        if include_optional:
            return MeshToolRegisterMetadata(
                function_name = 'greet',
                capability = 'greeting',
                version = '1.0.0',
                tags = ["demo","v1"],
    ...
    def testMeshToolRegisterMetadata(self):
        """Test MeshToolRegisterMetadata"""
