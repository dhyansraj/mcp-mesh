...
class TestRichDependency(unittest.TestCase):
    """RichDependency unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichDependency:
        """Test RichDependency
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RichDependency`
        """
        model = RichDependency()
        if include_optional:
