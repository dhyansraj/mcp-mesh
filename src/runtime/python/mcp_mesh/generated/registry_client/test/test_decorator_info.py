...
class TestDecoratorInfo(unittest.TestCase):
    """DecoratorInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DecoratorInfo:
        """Test DecoratorInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DecoratorInfo`
        """
        model = DecoratorInfo()
        if include_optional:
