...
class AgentMetadata(BaseModel):
    ...
    capabilities: Optional[Annotated[list[StrictStr], Field(min_length=0)]] = Field(
        default=None, description="List of capabilities provided by agent (0 or more)"
    )
    dependencies: Optional[
        Annotated[list[AgentMetadataDependenciesInner], Field(min_length=0)]
    ] = Field(
        default=None,
        description="List of agent dependencies (0 or more) - supports both simple strings and rich objects",
    )
    health_interval: Optional[Annotated[int, Field(le=3600, strict=True, ge=1)]] = (
        Field(default=30, description="Health check interval in seconds")
    )
    timeout_threshold: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(
        default=60, description="Timeout threshold in seconds"
    )
    eviction_threshold: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(
    ...
    security_context: Optional[StrictStr] = Field(
