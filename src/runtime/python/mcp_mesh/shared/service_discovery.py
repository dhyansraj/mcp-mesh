...
class ServiceDiscovery:
    ...
    def __init__(self, registry_client: AgentsApi | None = None):
        ...
        if registry_client is None:
            ...
            registry_client = AgentsApi(api_client)
        ...
        try:
            ...
            try:
                ...
                registration_data = {
                    ...
                    "tools": [],  # Basic registration without tools
                }
    ...
    async def update_agent_health(
        ...
        try:
            ...
            try:
                ...
                heartbeat_data = {
                    "agent_id": agent_id,
                    "tools": [],  # Empty for heartbeat
                    **health_data,  # Include health data fields
                }
    ...
    async def _get_all_agents(self) -> list[AgentInfo]:
        ...
        try:
            # Fetch from registry using list_agents
            agents_response = await self.registry_client.list_agents()

            # Convert to AgentInfo objects
            agents = []
            if hasattr(agents_response, "agents") and agents_response.agents:
                for agent_dict in agents_response.agents:
                    # Convert pydantic model to dict if needed
                    if hasattr(agent_dict, "model_dump"):
                        agent_dict = agent_dict.model_dump()
    ...
    async def _get_agent_by_id(self, agent_id: str) -> AgentInfo | None:
        ...
        try:
            # Fetch all agents since there's no get_agent method
            agents_response = await self.registry_client.list_agents()
