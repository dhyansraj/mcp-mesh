...
class AgentMetadataDependenciesInnerOneOf(BaseModel):
    ...
    tags: Optional[list[StrictStr]] = Field(
        default=None, description="Optional tags for smart matching"
    )
    version: Optional[StrictStr] = Field(
        default=None, description="Optional version constraint"
    )
    namespace: Optional[StrictStr] = Field(
        default="default", description="Optional namespace filter"
    )
