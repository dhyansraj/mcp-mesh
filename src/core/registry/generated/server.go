...
// Valid indicates whether the value is a known member of the AgentInfoAgentType enum.
func (e AgentInfoAgentType) Valid() bool {
	switch e {
	case AgentInfoAgentTypeApi:
		return true
	case AgentInfoAgentTypeMcpAgent:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AgentInfoRuntime enum.
func (e AgentInfoRuntime) Valid() bool {
	switch e {
	case AgentInfoRuntimeJava:
		return true
	case AgentInfoRuntimePython:
		return true
	case AgentInfoRuntimeTypescript:
		return true
	default:
		return false
	}
...
func (e AgentInfoStatus) Valid() bool {
	switch e {
	case AgentInfoStatusDegraded:
		return true
	case AgentInfoStatusHealthy:
		return true
	case AgentInfoStatusOffline:
		return true
	case AgentInfoStatusUnhealthy:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DependencyResolutionInfoStatus enum.
func (e DependencyResolutionInfoStatus) Valid() bool {
	switch e {
	case DependencyResolutionInfoStatusAvailable:
		return true
	case DependencyResolutionInfoStatusUnavailable:
		return true
	case DependencyResolutionInfoStatusUnresolved:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LLMProviderResolutionInfoStatus enum.
func (e LLMProviderResolutionInfoStatus) Valid() bool {
	switch e {
	case LLMProviderResolutionInfoStatusAvailable:
		return true
	case LLMProviderResolutionInfoStatusUnavailable:
		return true
	case LLMProviderResolutionInfoStatusUnresolved:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LLMToolFilterFilterMode enum.
func (e LLMToolFilterFilterMode) Valid() bool {
	switch e {
	case LLMToolFilterFilterModeAll:
		return true
	case LLMToolFilterFilterModeAsterisk:
		return true
	case LLMToolFilterFilterModeBestMatch:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LLMToolResolutionInfoFilterMode enum.
func (e LLMToolResolutionInfoFilterMode) Valid() bool {
	switch e {
	case LLMToolResolutionInfoFilterModeAll:
		return true
	case LLMToolResolutionInfoFilterModeAsterisk:
		return true
	case LLMToolResolutionInfoFilterModeBestMatch:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LLMToolResolutionInfoStatus enum.
func (e LLMToolResolutionInfoStatus) Valid() bool {
	switch e {
	case LLMToolResolutionInfoStatusAvailable:
		return true
	case LLMToolResolutionInfoStatusUnavailable:
		return true
	case LLMToolResolutionInfoStatusUnresolved:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MeshAgentRegistrationAgentType enum.
func (e MeshAgentRegistrationAgentType) Valid() bool {
	switch e {
	case MeshAgentRegistrationAgentTypeApi:
		return true
	case MeshAgentRegistrationAgentTypeMcpAgent:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MeshAgentRegistrationRuntime enum.
func (e MeshAgentRegistrationRuntime) Valid() bool {
	switch e {
	case MeshAgentRegistrationRuntimeJava:
		return true
	case MeshAgentRegistrationRuntimePython:
		return true
	case MeshAgentRegistrationRuntimeTypescript:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MeshRegistrationResponseDependenciesResolvedStatus enum.
func (e MeshRegistrationResponseDependenciesResolvedStatus) Valid() bool {
	switch e {
	case MeshRegistrationResponseDependenciesResolvedStatusAvailable:
		return true
	case MeshRegistrationResponseDependenciesResolvedStatusDegraded:
		return true
	case MeshRegistrationResponseDependenciesResolvedStatusUnavailable:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MeshRegistrationResponseStatus enum.
func (e MeshRegistrationResponseStatus) Valid() bool {
	switch e {
	case Error:
		return true
	case Success:
...
// Valid indicates whether the value is a known member of the RegistryEventInfoEventType enum.
func (e RegistryEventInfoEventType) Valid() bool {
	switch e {
	case RegistryEventInfoEventTypeExpire:
		return true
	case RegistryEventInfoEventTypeRegister:
		return true
	case RegistryEventInfoEventTypeRotate:
		return true
	case RegistryEventInfoEventTypeUnhealthy:
		return true
	case RegistryEventInfoEventTypeUnregister:
		return true
	case RegistryEventInfoEventTypeUpdate:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ResolvedLLMProviderStatus enum.
func (e ResolvedLLMProviderStatus) Valid() bool {
	switch e {
	case Available:
		return true
	case Degraded:
...
// Valid indicates whether the value is a known member of the GetEventsHistoryParamsEventType enum.
func (e GetEventsHistoryParamsEventType) Valid() bool {
	switch e {
	case GetEventsHistoryParamsEventTypeExpire:
		return true
	case GetEventsHistoryParamsEventTypeRegister:
		return true
	case GetEventsHistoryParamsEventTypeRotate:
		return true
	case GetEventsHistoryParamsEventTypeUnhealthy:
		return true
	case GetEventsHistoryParamsEventTypeUnregister:
		return true
	case GetEventsHistoryParamsEventTypeUpdate:
		return true
	default:
		return false
	}
...
func (siw *ServerInterfaceWrapper) UnregisterAgent(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "agent_id", c.Param("agent_id"), &agentId, runtime.BindStyledParameterOptions{Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetEventsHistory(c *gin.Context) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "event_type", c.Request.URL.Query(), &params.EventType, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) StreamTrace(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "trace_id", c.Param("trace_id"), &traceId, runtime.BindStyledParameterOptions{Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
