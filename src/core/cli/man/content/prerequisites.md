...
| Image                              | Description                 |
| ---------------------------------- | --------------------------- |
| `mcpmesh/registry:2.8.2`           | Registry service            |
| `mcpmesh/python-runtime:2.8.2`     | Python runtime with SDK     |
| `mcpmesh/java-runtime:2.8.2`       | Java runtime with SDK       |
| `mcpmesh/typescript-runtime:2.8.2` | TypeScript runtime with SDK |

```bash
# Pull images
docker pull mcpmesh/registry:2.8.2
docker pull mcpmesh/python-runtime:2.8.2
docker pull mcpmesh/java-runtime:2.8.2
docker pull mcpmesh/typescript-runtime:2.8.2
```
