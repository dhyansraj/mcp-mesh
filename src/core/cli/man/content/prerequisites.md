...
| `mcpmesh/python-runtime:2.0.0-beta.3`     | Python runtime with SDK     |
| `mcpmesh/java-runtime:2.0.0-beta.3`       | Java runtime with SDK       |
| `mcpmesh/typescript-runtime:2.0.0-beta.3` | TypeScript runtime with SDK |

```bash
# Pull images
docker pull mcpmesh/registry:2.0.0-beta.3
docker pull mcpmesh/python-runtime:2.0.0-beta.3
docker pull mcpmesh/java-runtime:2.0.0-beta.3
docker pull mcpmesh/typescript-runtime:2.0.0-beta.3
```
