...
| `mcpmesh/python-runtime:3.5.0`       | Python runtime with mcp-mesh SDK pre-installed     |
| `mcpmesh/typescript-runtime:3.5.0`   | TypeScript runtime with @mcpmesh/sdk pre-installed |
| `mcpmesh/java-runtime:3.5.0`         | Java runtime with mcp-mesh Spring Boot starter     |
| `mcpmesh/ui:3.5.0`                   | Dashboard UI server (basePath: /ops/dashboard)     |
| `mcpmesh/cli:3.5.0`                  | meshctl CLI for management                         |
...
```dockerfile
FROM mcpmesh/python-runtime:3.5.0
WORKDIR /app
...
helm install greeter oci://ghcr.io/dhyansraj/mcp-mesh/mcp-mesh-agent \
  --version 3.5.0 -n team-a -f greeter/helm-values.yaml
...
helm install greeter oci://ghcr.io/dhyansraj/mcp-mesh/mcp-mesh-agent \
  --version 3.5.0 -n team-b -f greeter/helm-values.yaml
```
...
```bash
# Docker
docker run -e MCP_MESH_UI_BASE_PATH=/my/custom/path mcpmesh/ui:3.5.0
