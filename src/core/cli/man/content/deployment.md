...
| `mcpmesh/python-runtime:2.2.4`       | Python runtime with mcp-mesh SDK pre-installed     |
| `mcpmesh/typescript-runtime:2.2.4`   | TypeScript runtime with @mcpmesh/sdk pre-installed |
| `mcpmesh/java-runtime:2.2.4`         | Java runtime with mcp-mesh Spring Boot starter     |
| `mcpmesh/ui:2.2.4`                   | Dashboard UI server (basePath: /ops/dashboard)     |
| `mcpmesh/cli:2.2.4`                  | meshctl CLI for management                         |
...
helm install greeter oci://ghcr.io/dhyansraj/mcp-mesh/mcp-mesh-agent \
  --version 2.2.4 -n team-a -f greeter/helm-values.yaml
...
helm install greeter oci://ghcr.io/dhyansraj/mcp-mesh/mcp-mesh-agent \
  --version 2.2.4 -n team-b -f greeter/helm-values.yaml
```
...
```bash
# Docker
docker run -e MCP_MESH_UI_BASE_PATH=/my/custom/path mcpmesh/ui:2.2.4
