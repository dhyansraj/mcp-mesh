...
| Image                            | Description                 |
| -------------------------------- | --------------------------- |
| `mcpmesh/registry:2.8.1`           | Registry service            |
| `mcpmesh/python-runtime:2.8.1`     | Python runtime with SDK     |
| `mcpmesh/java-runtime:2.8.1`       | Java runtime with SDK       |
| `mcpmesh/typescript-runtime:2.8.1` | TypeScript runtime with SDK |

```bash
# Pull images
docker pull mcpmesh/registry:2.8.1
docker pull mcpmesh/python-runtime:2.8.1
docker pull mcpmesh/java-runtime:2.8.1
docker pull mcpmesh/typescript-runtime:2.8.1
```
