...
Infrastructure:
  Docker Images:
    ...
    mcpmesh/python-runtime:2.0.0-beta.1      - Python agent runtime (has mcp-mesh SDK)
    mcpmesh/typescript-runtime:2.0.0-beta.1  - TypeScript agent runtime (has @mcpmesh/sdk)
