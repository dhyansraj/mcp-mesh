...
=== "Docker Images"
    ...
    ```bash
    docker pull mcpmesh/registry:2.3.0
    docker pull mcpmesh/python-runtime:2.3.0
    docker pull mcpmesh/java-runtime:2.3.0
    docker pull mcpmesh/typescript-runtime:2.3.0
    ```
...
- **Latest Release**: v2.3.0 (March 2026)
- **License**: MIT
