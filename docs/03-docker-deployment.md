...
| Image                            | Purpose                                          |
| -------------------------------- | ------------------------------------------------ |
| `mcpmesh/registry:1.3.3`           | Go-based registry service                        |
| `mcpmesh/python-runtime:1.3.3`     | Python agent runtime (includes mcp-mesh SDK)     |
| `mcpmesh/java-runtime:1.3.3`       | Java agent runtime (includes mcp-mesh SDK)       |
| `mcpmesh/typescript-runtime:1.3.3` | TypeScript agent runtime (includes @mcpmesh/sdk) |
...
=== "Python"
    ...
    services:
      ...
      my-agent:
        image: mcpmesh/python-runtime:1.3.3
        ports:
          - "8080:8080"
        volumes:
...
=== "TypeScript"
    ...
    services:
      ...
      my-agent:
        image: mcpmesh/typescript-runtime:1.3.3
        ports:
          - "8080:8080"
        volumes:
          - ./my-agent:/app/agent:ro
...
=== "TypeScript"
    ...
    ```dockerfile
    FROM mcpmesh/typescript-runtime:1.3.3
