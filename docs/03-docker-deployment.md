...
| Image                            | Purpose                                          |
| -------------------------------- | ------------------------------------------------ |
| `mcpmesh/registry:3.6.0`           | Go-based registry service                        |
| `mcpmesh/python-runtime:3.6.0`     | Python agent runtime (includes mcp-mesh SDK)     |
| `mcpmesh/java-runtime:3.6.0`       | Java agent runtime (includes mcp-mesh SDK)       |
| `mcpmesh/typescript-runtime:3.6.0` | TypeScript agent runtime (includes @mcpmesh/sdk) |
...
=== "TypeScript"
    ...
    ```dockerfile
    FROM mcpmesh/typescript-runtime:3.6.0
