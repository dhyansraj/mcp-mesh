...
| Image                            | Purpose                                          |
| -------------------------------- | ------------------------------------------------ |
| `mcpmesh/registry:2.2.3`           | Go-based registry service                        |
| `mcpmesh/python-runtime:2.2.3`     | Python agent runtime (includes mcp-mesh SDK)     |
| `mcpmesh/java-runtime:2.2.3`       | Java agent runtime (includes mcp-mesh SDK)       |
| `mcpmesh/typescript-runtime:2.2.3` | TypeScript agent runtime (includes @mcpmesh/sdk) |
...
=== "TypeScript"
    ...
    services:
      ...
      my-agent:
        image: mcpmesh/typescript-runtime:2.2.3
        ports:
          - "8080:8080"
        volumes:
          - ./my-agent:/app/agent:ro
...
=== "TypeScript"
    ...
    ```dockerfile
    FROM mcpmesh/typescript-runtime:2.2.3
