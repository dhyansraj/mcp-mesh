...
| Image                            | Purpose                                          |
| -------------------------------- | ------------------------------------------------ |
| `mcpmesh/registry:2.0.1`           | Go-based registry service                        |
| `mcpmesh/python-runtime:2.0.1`     | Python agent runtime (includes mcp-mesh SDK)     |
| `mcpmesh/java-runtime:2.0.1`       | Java agent runtime (includes mcp-mesh SDK)       |
| `mcpmesh/typescript-runtime:2.0.1` | TypeScript agent runtime (includes @mcpmesh/sdk) |
...
=== "Python"
    ...
    services:
      ...
      my-agent:
        image: mcpmesh/python-runtime:2.0.1
        ports:
          - "8080:8080"
        volumes:
...
=== "TypeScript"
    ...
    services:
      ...
      my-agent:
        image: mcpmesh/typescript-runtime:2.0.1
        ports:
          - "8080:8080"
        volumes:
          - ./my-agent:/app/agent:ro
...
=== "TypeScript"
    ...
    ```dockerfile
    FROM mcpmesh/typescript-runtime:2.0.1
