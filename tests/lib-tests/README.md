...
- `tsuite-mesh:2.0.0-beta.3` (or current version) Docker image
...
packages:
  ...
  sdk_python_version: "2.0.0-beta.3" # PEP 440 format for Python
  sdk_typescript_version: "2.0.0-beta.3"
  core_version: "2.0.0-beta.3"
  sdk_java_version: "2.0.0-beta.3"
```
