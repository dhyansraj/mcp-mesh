...
- `tsuite-mesh:0.9.11` (or current version) Docker image
...
packages:
  cli_version: "0.9.11"
  sdk_python_version: "0.9.11" # PEP 440 format for Python
  sdk_typescript_version: "0.9.11"
  core_version: "0.9.11"
  sdk_java_version: "0.9.11"
```
