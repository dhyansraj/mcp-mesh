...
- `tsuite-mesh:2.0.0-beta.1` (or current version) Docker image
...
```yaml
packages:
  cli_version: "2.0.0-beta.1"
  sdk_python_version: "2.0.0-beta.1" # PEP 440 format for Python
  sdk_typescript_version: "2.0.0-beta.1"
  core_version: "2.0.0-beta.1"
  sdk_java_version: "2.0.0-beta.1"
```
