...
```yaml
packages:
  cli_version: "2.0.0-beta.1" # @mcpmesh/cli
  sdk_python_version: "2.0.0-beta.1" # mcp-mesh (pip) - PEP 440 format
  sdk_typescript_version: "2.0.0-beta.1" # @mcpmesh/sdk

docker:
  base_image: "tsuite-mesh:2.0.0-beta.1"
```
