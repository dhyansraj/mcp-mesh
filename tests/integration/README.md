...
```yaml
packages:
  cli_version: "0.9.10" # @mcpmesh/cli
  sdk_python_version: "0.9.10" # mcp-mesh (pip) - PEP 440 format
  sdk_typescript_version: "0.9.10" # @mcpmesh/sdk

docker:
  base_image: "tsuite-mesh:0.9.10"
```
