#!/usr/bin/env python3
"""
structured-agent - MCP Mesh LLM Agent with Structured Output

Tests that OpenAI provider correctly returns structured data (Pydantic model)
...
def get_country_info(
    ...
    structured output mode with OpenAI.
...
@mesh.agent(
    ...
    version="1.0.0",
    description="LLM agent testing structured output",
    http_port=9020,
    enable_http=True,
    auto_run=True,
)
class StructuredAgentAgent:
    """Agent for testing structured output with OpenAI."""
