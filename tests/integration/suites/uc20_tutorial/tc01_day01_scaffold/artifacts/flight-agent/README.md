...
TripPlanner flight search tool (Day 1). Searches for flights between two cities on a given date.
...
|------|------------|-------------|
| `flight_search` | `flight_search` | Search for flights between two cities on a given date |
