"""Calculator agent that demonstrates tag-level OR alternatives.

This agent demonstrates:
1. Simple local tools (calc_add, calc_multiply)
2. Multi-dependency injection with tag-level OR:
   tags: ["addition", ["python", "typescript"]] = addition AND (python OR typescript)
   Prefers python provider, falls back to typescript if unavailable.
"""
