#!/usr/bin/env python3
"""Gated MeshJob worker — replica A (uc33, issue #1252 Phase 4).
...
@mesh.agent(
    name="gated-worker-a",
    version="1.0.0",
    description="Gated MeshJob worker replica A (uc33) — multi-replica execution integrity fixture.",
    http_port=int(os.environ.get("MCP_MESH_HTTP_PORT", "9111")),
    enable_http=True,
    auto_run=True,
)
class GatedWorkerA:
