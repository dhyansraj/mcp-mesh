...
| Variable                                 | Example      |
| ---------------------------------------- | ------------ |
| `config.packages.cli_version`            | 2.0.0-beta.2 |
| `config.packages.sdk_python_version`     | 2.0.0-beta.2 |
| `config.packages.sdk_typescript_version` | 2.0.0-beta.2 |
