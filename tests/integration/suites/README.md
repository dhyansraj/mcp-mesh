...
| Variable                                 | Example      |
| ---------------------------------------- | ------------ |
| `config.packages.cli_version`            | 1.1.0-beta.1 |
| `config.packages.sdk_python_version`     | 1.1.0-beta.1 |
| `config.packages.sdk_typescript_version` | 1.1.0-beta.1 |
