#!/usr/bin/env python3
"""
claude-provider-py - MCP Mesh LLM Provider
...
async def health_check() -> dict:
    """
    Health check for claude-provider-py.
...
@mesh.llm_provider(
    ...
    capability="llm",
    tags=["llm", "claude", "python", "provider"],
    version="1.0.0",
)
def claude_provider_py():
    """
    Zero-code LLM provider for claude-provider-py.
