#!/usr/bin/env python3
"""
gemini-provider-py - MCP Mesh LLM Provider
...
async def health_check() -> dict:
    """
    Health check for gemini-provider-py.
...
@mesh.llm_provider(
    ...
    capability="llm",
    tags=["llm", "gemini", "python", "provider"],
    version="1.0.0",
)
def gemini_provider_py():
    """
    Zero-code LLM provider for gemini-provider-py.
