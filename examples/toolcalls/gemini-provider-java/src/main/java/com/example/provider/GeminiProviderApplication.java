 ...
 * cd examples/toolcalls/gemini-provider-java
 * mvn spring-boot:run
 * </pre>
 */
@MeshAgent(
    name = "gemini-provider-java",
    version = "1.0.0",
    description = "Google Gemini LLM provider for mesh (Java)",
    port = 9112
)
@MeshLlmProvider(
    model = "gemini/gemini-3-flash-preview",
    capability = "llm",
    tags = {"llm", "gemini", "google", "vertex-ai", "java", "provider"},
    version = "1.0.0"
)
...
public class GeminiProviderApplication {
    ...
    public static void main(String[] args) {
        log.info("Starting Gemini Provider Agent (Java)...");
