 ...
 *
 * # Start an OpenAI LLM provider (e.g., examples/llm-provider/openai_provider.py)
 * meshctl start -d examples/llm-provider/openai_provider.py
 *
 * # Start the slow tool agent
 * meshctl start -d examples/parallel-tools/slow-tool-java
 *
 * # Run this agent
 * meshctl start examples/parallel-tools/consumer-openai-java -d
 *
