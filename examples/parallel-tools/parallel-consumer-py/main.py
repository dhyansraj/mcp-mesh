#!/usr/bin/env python3
"""
parallel-consumer-py - MCP Mesh LLM Agent

A MCP Mesh LLM agent that tests parallel tool execution.
Uses parallel_tool_calls=True to enable simultaneous tool calls.
"""
...
app = FastMCP("ParallelConsumerPy Service")
