#!/usr/bin/env python3
"""
direct-consumer-claude-py - MCP Mesh Direct LLM Agent (Claude)
...
app = FastMCP("DirectConsumerClaudePy Service")
...
@mesh.agent(
    name="direct-consumer-claude-py",
    version="1.0.0",
...
class DirectConsumerClaudePyAgent:
    pass
