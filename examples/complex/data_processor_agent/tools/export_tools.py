...
class DataExporter:
        ...
        **kwargs,
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(
                suffix=f".{format_type.lower()}", delete=False
            ) as temp_file:
            ...
            return {"error": f"Export failed: {str(e)}", "format": format_type}
    ...
    def _export_json(
        ...
        return {
            "format_options": {"orient": orient, "indent": indent},
    ...
    def _export_parquet(
        ...
        return {
            "format_options": {"engine": engine, "compression": compression},
