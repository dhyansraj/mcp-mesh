...
|------|------------|-------------|
| `budget_analyst` | `budget_analyst` | Process input using LLM |
...
Edit the `BudgetAnalystContext` class to add fields needed for your use case:

```python
class BudgetAnalystContext(BaseModel):
