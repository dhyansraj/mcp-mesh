...
This is a zero-code LLM provider that exposes openai/gpt-4o-mini to other MCP Mesh agents.
...
The provider will start on port 9108 by default.

## Configuration

| Parameter | Value | Description |
|-----------|-------|-------------|
| Model | openai/gpt-4o-mini | LiteLLM model identifier |
| Port | 9108 | HTTP server port |
| Tags |  | Discovery tags |
