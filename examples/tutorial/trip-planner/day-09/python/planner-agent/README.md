...
The agent will start on port 9107 by default.
...
|------|------------|-------------|
| `planner_agent` | `planner_agent` | Process input using LLM |
...
Edit the `PlannerAgentContext` class to add fields needed for your use case:
