...
from mcp_mesh_runtime.fallback import FallbackConfiguration, FallbackMode

# Create FastMCP app for dual-decorator pattern
app = FastMCP("fallback-chain-demo")
...
@app.tool(
    name="advanced_analytics_pipeline",
...
@app.tool(
    name="reporting_service", description="Reporting service with injected dependencies"
)
@mesh_agent(
