...
app = FastMCP("unified-dependency-patterns")
...
@app.tool(
    name="comprehensive_secure_operation",
    description="Comprehensive operation using all three dependency patterns",
)
@mesh_agent(
...
@app.tool(
    name="protocol_only_auth",
    description="Function that only uses protocol-based dependencies",
)
@mesh_agent(
    capabilities=["auth"],
...
@app.tool(
    name="concrete_only_operation",
    description="Function that only uses concrete class dependencies",
)
@mesh_agent(
...
@app.tool(
    name="legacy_only_operation",
    description="Function that only uses legacy string dependencies",
)
@mesh_agent(
    capabilities=["legacy"],
